...
import com.example.ecommerceappnew.Adapters.SliderAdapter;
...
TextView[] dots;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Going to Registartion Activity
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(oNBoardActivity.this,RegistartionActivity.class));
                finish();
            }
        });
